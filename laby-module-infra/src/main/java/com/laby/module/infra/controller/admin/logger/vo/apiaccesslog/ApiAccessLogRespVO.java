package com.laby.module.infra.controller.admin.logger.vo.apiaccesslog;

import com.laby.framework.excel.core.annotations.DictFormat;
import com.laby.framework.excel.core.convert.DictConvert;
import com.laby.module.infra.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(com.laby.module.infra.enums.DictTypeConstants.OPERATE_TYPE)

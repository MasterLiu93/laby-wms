package com.laby.framework.tracer.config;

import com.laby.framework.common.enums.WebFilterOrderEnum;
import com.laby.framework.tracer.core.aop.BizTraceAspect;
import com.laby.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "laby.tracer", value = "enable", matchIfMissing = true)
public class LabyTracerAutoConfiguration {

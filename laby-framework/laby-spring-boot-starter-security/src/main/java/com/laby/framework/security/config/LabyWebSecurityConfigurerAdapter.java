package com.laby.framework.security.config;

import cn.hutool.core.collection.CollUtil;
import com.laby.framework.security.core.filter.TokenAuthenticationFilter;
...
public class LabyWebSecurityConfigurerAdapter {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(c -> c
                    ...
                    // 1.3 基于 laby.security.permit-all-urls 无需认证

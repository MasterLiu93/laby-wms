package com.laby.framework.tenant.config;
...
import com.laby.framework.redis.config.LabyCacheProperties;
import com.laby.framework.security.core.service.SecurityFrameworkService;
import com.laby.framework.tenant.core.aop.TenantIgnore;
import com.laby.framework.tenant.core.aop.TenantIgnoreAspect;
import com.laby.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.laby.framework.tenant.core.job.TenantJobAspect;
import com.laby.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.laby.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.laby.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.laby.framework.tenant.core.redis.TenantRedisCacheManager;
import com.laby.framework.tenant.core.security.TenantSecurityWebFilter;
import com.laby.framework.tenant.core.service.TenantFrameworkService;
import com.laby.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.laby.framework.tenant.core.web.TenantContextWebFilter;
import com.laby.framework.tenant.core.web.TenantVisitContextInterceptor;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "laby.tenant", value = "enable", matchIfMissing = true) // 允许使用 laby.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class LabyTenantAutoConfiguration {
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     LabyCacheProperties labyCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(labyCacheProperties.getRedisScanBatchSize()));

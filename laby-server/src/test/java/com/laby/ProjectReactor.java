...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.laby.boot";
    private static final String ARTIFACT_ID = "laby";
    private static final String PACKAGE_NAME = "com.laby";
    private static final String TITLE = "Laby管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.laby.boot";
        String artifactIdNew = "laby";
        String packageNameNew = "com.laby";
        String titleNew = "Laby管理系统";
        String projectBaseDirNew = "D:\\ideaProject\\" + "laby-service"; // 一键改名后，“新”项目所在的目录

...
public class InboundItemRespVO {
    ...
    @Schema(description = "商品名称（关联查询字段）", example = "iPhone 15 Pro Max")
    ...
    @Schema(description = "规格描述（关联查询字段）", example = "512GB 深空黑色")
    private String spec;

    @Schema(description = "品牌（关联查询字段）", example = "Apple")
    private String brand;

    @Schema(description = "库位ID", example = "1")
    private Long locationId;

    @Schema(description = "库区ID（关联查询字段）", example = "1")
    private Long areaId;

    @Schema(description = "库区名称（关联查询字段）", example = "A库区")
    private String areaName;

    @Schema(description = "库位编码（关联查询字段）", example = "A-01-001")
    ...
    @Schema(description = "实收数量", example = "98")
    private BigDecimal receivedQuantity;

    @Schema(description = "合格数量", example = "95")
    private BigDecimal qualifiedQuantity;

    @Schema(description = "不合格数量", example = "3")

...
public interface ErrorCodeConstants {
    ...
    ErrorCode INVENTORY_UPDATE_FAIL = new ErrorCode(1_020_005_003, "库存更新失败，请重试");
    ...
    ErrorCode INBOUND_NOT_ALL_RECEIVED = new ErrorCode(1_020_006_006, "还有明细未确认收货，无法完成入库");
    ErrorCode INBOUND_NO_QUALIFIED = new ErrorCode(1_020_006_007, "所有明细的合格数量都为0，无法完成入库");
    ...
    ErrorCode PICKING_WAVE_NOT_ALLOW_GENERATE_TASK = new ErrorCode(1_020_009_008, "拣货波次状态不允许生成任务，请确认波次状态为待分配");
    ...
    ErrorCode STOCK_TAKING_PLAN_NOT_ALLOW_GENERATE = new ErrorCode(1_020_014_005, "盘点计划状态不允许生成盘点单");
    ...
    ErrorCode STOCK_TAKING_NOT_ALLOW_CONFIRM = new ErrorCode(1_020_014_102, "盘点单状态不允许确认");
    ErrorCode STOCK_TAKING_NOT_ALLOW_REVIEW = new ErrorCode(1_020_014_103, "盘点单状态不允许复核");
    ErrorCode STOCK_TAKING_NOT_ALLOW_ADJUST = new ErrorCode(1_020_014_104, "盘点单状态不允许调整");

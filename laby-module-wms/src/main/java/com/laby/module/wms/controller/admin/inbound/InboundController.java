...
public class InboundController {
     ...
     * @return 是否成功
     */
    @PutMapping("/complete-receiving")
    @Operation(summary = "确认收货（单个明细）")
    @PreAuthorize("@ss.hasPermission('wms:inbound:receive')")
    public CommonResult<Boolean> receiveItem(@RequestParam("id") Long id,
                                               @RequestParam("itemId") Long itemId,
                                               @RequestParam("receivedQuantity") Integer receivedQuantity,
                                               @RequestParam("qualifiedQuantity") Integer qualifiedQuantity,
                                               @RequestParam("unqualifiedQuantity") Integer unqualifiedQuantity) {
        inboundService.receiveItem(id, itemId, receivedQuantity, qualifiedQuantity, unqualifiedQuantity);
        return success(true);
    }

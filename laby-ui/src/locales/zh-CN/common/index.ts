...
export default {
  ...
  login: {
    ...
    socialMethodNotConfigured: '此方式未配置',
    inputTenantName: '请输入租户名称',
    passwordMismatch: '两次输入的密码不一致',
    passwordRequired: '请再次输入密码'
  },
  captcha: {
    verify: '验证',
  ...
  sys: {
    ...
    login: {
      ...
      registerSubtitle: '创建新账号，开始您的旅程',
      mobileSubtitle: '使用手机号快速登录',
      qrcodeSubtitle: '扫描二维码快速登录',
      ssoSubtitle: '使用第三方账号登录',
      resetPasswordSubtitle: '请填写您的邮箱或手机号，我们将发送验证码',

/**
 * Common Module Internationalization File Summary (English)
 */
export default {
  common: {
    ...
    selectDateTimeText: 'Select date and time',
    import: 'Import',
    export: 'Export',
  ...
  login: {
    ...
    socialMethodNotConfigured: 'This method is not configured',
    inputTenantName: 'Please enter tenant name',
    passwordMismatch: 'The two passwords are inconsistent',
    passwordRequired: 'Please enter password again',
  ...
  sys: {
    ...
    login: {
      ...
      registerSubtitle: 'Create a new account and start your journey',
      mobileSubtitle: 'Quick login with your mobile phone',
      qrcodeSubtitle: 'Scan QR code for quick login',
      ssoSubtitle: 'Login with third-party account',
      resetPasswordSubtitle: 'Please enter your email or mobile number, we will send you a verification code',

...
// 根据仓库ID获得库位列表（用于入库单选择库位）
export const getWarehouseLocationListByWarehouseId = (warehouseId: number) => {
  return request.get({ url: '/wms/warehouse-location/list-by-warehouse-id?warehouseId=' + warehouseId })
}

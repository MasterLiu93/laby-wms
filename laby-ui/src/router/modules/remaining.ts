...
const remainingRouter: AppRouteRecordRaw[] = [
    ...
    children: [
      {
        ...
        meta: {
          get title() {
            ...
            return localeStore.getCurrentLocale.lang === 'en' ? 'Home' : '首页'
          },
          icon: 'ep:home-filled',
          noCache: false,
          affix: true
    ...
    children: [
      {
        ...
        meta: {
          ...
          get title() {
            const localeStore = useLocaleStoreWithOut()
            return localeStore.getCurrentLocale.lang === 'en' ? 'Profile' : '个人中心'
          }
        }
      },
      {
  ...
  },
  {
    ...
    meta: {
      ...
      get title() {
        const localeStore = useLocaleStoreWithOut()
        return localeStore.getCurrentLocale.lang === 'en' ? 'Login' : '登录'
      },
      noTagsView: true
    }
  },
  ...
  },
  {
    ...
    meta: {
      ...
      get title() {
        const localeStore = useLocaleStoreWithOut()
        return localeStore.getCurrentLocale.lang === 'en' ? 'Social Login' : '社交登录'
      },
      noTagsView: true
    }
  },

<template>
    ...
    >
      <el-form-item :label="t('system.oauth2.client.name')" prop="name">
        <el-input
          ...
          :placeholder="t('system.oauth2.client.namePlaceholder')"
          clearable
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" @selection-change="handleRowCheckboxChange">
      ...
      <el-table-column :label="t('system.oauth2.client.secret')" align="center" prop="secret" />
      <el-table-column :label="t('system.oauth2.client.name')" align="center" prop="name" />
      <el-table-column :label="t('system.oauth2.client.logo')" align="center" prop="logo">
      ...
      <el-table-column :label="t('system.oauth2.client.accessTokenValiditySeconds')" align="center" prop="accessTokenValiditySeconds">
        <template #default="scope">{{ scope.row.accessTokenValiditySeconds }} {{ t('system.oauth2.client.seconds') }}</template>
      </el-table-column>
      <el-table-column :label="t('system.oauth2.client.refreshTokenValiditySeconds')" align="center" prop="refreshTokenValiditySeconds">
        <template #default="scope">{{ scope.row.refreshTokenValiditySeconds }} {{ t('system.oauth2.client.seconds') }}</template>
      </el-table-column>
      <el-table-column :label="t('system.oauth2.client.authorizedGrantTypes')" align="center" prop="authorizedGrantTypes">
        <template #default="scope">
          <el-tag

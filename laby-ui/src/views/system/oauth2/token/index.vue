<template>
    ...
    >
      <el-form-item :label="t('system.oauth2.token.userId')" prop="userId">
        <el-input
          ...
          :placeholder="t('system.oauth2.token.userIdPlaceholder')"
          clearable
      ...
      <el-form-item :label="t('system.oauth2.token.userType')" prop="userType">
        <el-select
          ...
          :placeholder="t('system.oauth2.token.userTypePlaceholder')"
          clearable
          class="!w-240px"
        >
          <el-option
      ...
      <el-form-item :label="t('system.oauth2.token.clientId')" prop="clientId">
        <el-input
          ...
          :placeholder="t('system.oauth2.token.clientIdPlaceholder')"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column
        :label="t('system.oauth2.token.expiresTime')"
        align="center"
        prop="expiresTime"
      ...
      />
      <el-table-column
        :label="t('system.oauth2.token.createTime')"
        align="center"
        prop="createTime"
        :formatter="dateFormatter"
        width="180"
...
const handleForceLogout = async (accessToken: string) => {
  try {
    // 删除的二次确认
    await message.confirm(t('system.oauth2.token.forceLogoutConfirm'))
    // 发起删除

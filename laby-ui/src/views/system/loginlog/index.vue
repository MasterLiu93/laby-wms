<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item :label="t('system.loginLog.userIp')" prop="userIp">
        <el-input
          v-model="queryParams.userIp"
          :placeholder="t('system.loginLog.userIpPlaceholder')"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
      </el-form-item>
      <el-form-item :label="t('system.loginLog.createTime')" prop="createTime">
        <el-date-picker
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      <el-table-column :label="t('system.loginLog.id')" align="center" prop="id" />
      <el-table-column :label="t('system.loginLog.logType')" align="center" prop="logType">
      ...
      <el-table-column :label="t('system.loginLog.userIp')" align="center" prop="userIp" width="180" />
      <el-table-column :label="t('system.loginLog.userAgent')" align="center" prop="userAgent" />
      <el-table-column :label="t('system.loginLog.result')" align="center" prop="result">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.SYSTEM_LOGIN_RESULT" :value="scope.row.result" />
        </template>
      </el-table-column>
      <el-table-column
        :label="t('system.loginLog.createTime')"
        align="center"
        prop="createTime"
        width="180"
...
const handleExport = async () => {
  try {
    ...
    download.excel(data, t('system.loginLog.exportFileName') + '.xls')
  } catch {
  } finally {

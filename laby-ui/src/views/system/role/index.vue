<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" @selection-change="handleRowCheckboxChange">
      ...
      <el-table-column :label="t('system.role.type')" align="center" prop="type">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.SYSTEM_ROLE_TYPE" :value="scope.row.type" />
        </template>
      </el-table-column>
      <el-table-column align="center" :label="t('system.role.code')" prop="code" />
      <el-table-column align="center" :label="t('system.role.sort')" prop="sort" />
      ...
      <el-table-column
        ...
        width="180"
      />
      <el-table-column :width="300" align="center" :label="t('common.action')">
        <template #default="scope">
          <el-button
...
const handleExport = async () => {
  try {
    ...
    download.excel(data, t('system.role.exportFileName'))
  } catch {
  } finally {

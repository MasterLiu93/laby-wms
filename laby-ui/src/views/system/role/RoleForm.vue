  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      <el-form-item :label="t('system.role.name')" prop="name">
        <el-input v-model="formData.name" :placeholder="t('system.role.namePlaceholder')" />
      </el-form-item>
      <el-form-item :label="t('system.role.code')" prop="code">
        <el-input v-model="formData.code" :placeholder="t('system.role.codePlaceholder')" />
      </el-form-item>
      <el-form-item :label="t('system.role.sort')" prop="sort">
        <el-input v-model="formData.sort" :placeholder="t('system.role.sortPlaceholder')" />
      </el-form-item>
...
const formRules = reactive({
  ...
  code: [{ required: true, message: t('system.role.codeRequired'), trigger: 'change' }],
  sort: [{ required: true, message: t('system.role.sortRequired'), trigger: 'change' }],

  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      ...
      <el-form-item :label="t('system.dept.name')" prop="name">
        <el-input v-model="formData.name" :placeholder="t('system.dept.namePlaceholder')" />
      </el-form-item>
      <el-form-item :label="t('system.dept.sort')" prop="sort">
        <el-input-number v-model="formData.sort" :min="0" controls-position="right" />
      </el-form-item>
      <el-form-item :label="t('system.dept.leader')" prop="leaderUserId">
        <el-select v-model="formData.leaderUserId" clearable :placeholder="t('system.dept.leaderPlaceholder')">
          <el-option
      ...
      <el-form-item :label="t('system.dept.phone')" prop="phone">
        <el-input v-model="formData.phone" maxlength="11" :placeholder="t('system.dept.phonePlaceholder')" />
      </el-form-item>
      <el-form-item :label="t('system.dept.email')" prop="email">
        <el-input v-model="formData.email" maxlength="50" :placeholder="t('system.dept.emailPlaceholder')" />
      </el-form-item>
      <el-form-item :label="t('common.status')" prop="status">
        <el-select v-model="formData.status" clearable :placeholder="t('common.statusPlaceholder')">
          <el-option
...
const formRules = reactive<FormRules>({
  parentId: [{ required: true, message: t('system.dept.parentIdRequired'), trigger: 'blur' }],
  ...
  phone: [
    { pattern: /^1[3|4|5|6|7|8|9][0-9]\d{8}$/, message: t('system.dept.phoneInvalid'), trigger: 'blur' }
  ],
...
const getTree = async () => {
  ...
  let dept: Tree = { id: 0, name: t('system.dept.topDept'), children: [] }

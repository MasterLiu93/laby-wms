<template>
  <Dialog v-model="dialogVisible" :title="t('action.detail')" width="800">
    <el-descriptions :column="1" border>
      <el-descriptions-item :label="t('system.social.user.type')" min-width="160">
      ...
      <el-descriptions-item :label="t('system.social.user.token')" min-width="120">
        {{ detailData.token }}
      </el-descriptions-item>
      <el-descriptions-item :label="t('system.social.user.rawTokenInfo')" min-width="120">
        <el-input
      ...
      <el-descriptions-item :label="t('system.social.user.rawUserInfo')" min-width="120">
        <el-input
      ...
      <el-descriptions-item :label="t('system.social.user.code')" min-width="120">
        {{ detailData.code }}
      </el-descriptions-item>
      <el-descriptions-item :label="t('system.social.user.state')" min-width="120">
        {{ detailData.state }}
      </el-descriptions-item>
    </el-descriptions>
  </Dialog>

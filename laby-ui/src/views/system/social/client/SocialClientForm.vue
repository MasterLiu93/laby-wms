  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      <el-form-item :label="t('system.social.client.name')" prop="name">
        <el-input v-model="formData.name" :placeholder="t('system.social.client.namePlaceholder')" />
      </el-form-item>
      ...
      <el-form-item :label="t('system.social.client.clientId')" prop="clientId">
        <el-input v-model="formData.clientId" :placeholder="t('system.social.client.clientIdPlaceholder')" />
      </el-form-item>
      <el-form-item :label="t('system.social.client.clientSecret')" prop="clientSecret">
        <el-input
          v-model="formData.clientSecret"
          :placeholder="t('system.social.client.clientSecretPlaceholder')"
        />
      </el-form-item>
      <el-form-item :label="t('system.social.client.agentId')" prop="agentId" v-if="formData!.socialType === 30">
        <el-input v-model="formData.agentId" :placeholder="t('system.social.client.agentIdPlaceholder')" />
      </el-form-item>
...
const formRules = reactive({
  name: [{ required: true, message: t('system.social.client.nameRequired'), trigger: 'blur' }],
  socialType: [{ required: true, message: t('system.social.client.socialTypeRequired'), trigger: 'blur' }],

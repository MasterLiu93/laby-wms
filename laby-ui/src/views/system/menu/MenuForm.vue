<template>
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      ...
      <el-form-item v-if="formData.type !== 3" :label="t('system.menu.path')" prop="path">
        <template #label>
          <Tooltip
            :message="t('system.menu.pathTooltip')"
            :title="t('system.menu.path')"
          />
        </template>
        <el-input v-model="formData.path" clearable :placeholder="t('system.menu.pathPlaceholder')" />
      </el-form-item>
      <el-form-item v-if="formData.type === 2" :label="t('system.menu.component')" prop="component">
      ...
      <el-form-item v-if="formData.type !== 1" :label="t('system.menu.permission')" prop="permission">
        <template #label>
          <Tooltip
            :message="t('system.menu.permissionTooltip')"
      ...
      <el-form-item v-if="formData.type !== 3" :label="t('system.menu.visible')" prop="visible">
        <template #label>
          <Tooltip :message="t('system.menu.visibleTooltip')" :title="t('system.menu.visible')" />
        </template>
        <el-radio-group v-model="formData.visible">
          <el-radio key="true" :value="true" border>{{ t('system.menu.visibleShow') }}</el-radio>
          <el-radio key="false" :value="false" border>{{ t('system.menu.visibleHide') }}</el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item v-if="formData.type !== 3" :label="t('system.menu.alwaysShow')" prop="alwaysShow">
        <template #label>
          <Tooltip
            :message="t('system.menu.alwaysShowTooltip')"
      ...
      <el-form-item v-if="formData.type === 2" :label="t('system.menu.keepAlive')" prop="keepAlive">
        <template #label>
          <Tooltip
            :message="t('system.menu.keepAliveTooltip')"
            :title="t('system.menu.keepAlive')"
          />
        </template>
        <el-radio-group v-model="formData.keepAlive">
          <el-radio key="true" :value="true" border>{{ t('system.menu.keepAliveYes') }}</el-radio>
          <el-radio key="false" :value="false" border>{{ t('system.menu.keepAliveNo') }}</el-radio>
        </el-radio-group>
      </el-form-item>
    </el-form>
    <template #footer>

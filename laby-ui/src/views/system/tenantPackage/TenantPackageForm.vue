  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      <el-form-item :label="t('system.tenantPackage.name')" prop="name">
        <el-input v-model="formData.name" :placeholder="t('system.tenantPackage.namePlaceholder')" />
      </el-form-item>
      <el-form-item :label="t('system.tenantPackage.menuPermission')">
        <el-card class="w-full h-400px !overflow-y-scroll" shadow="never">
          ...
          <el-tree
            ...
            :data="menuOptions"
            :props="defaultProps"
            :empty-text="t('system.tenantPackage.loading')"
            node-key="id"
            show-checkbox
          />
        </el-card>
...
const formRules = reactive({
  name: [{ required: true, message: t('system.tenantPackage.nameRequired'), trigger: 'blur' }],
  status: [{ required: true, message: t('system.tenantPackage.statusRequired'), trigger: 'blur' }],
  menuIds: [{ required: true, message: t('system.tenantPackage.menuIdsRequired'), trigger: 'blur' }]
})

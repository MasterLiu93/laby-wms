      ...
      <ContentWrap>
        ...
        >
          ...
          <el-form-item>
            ...
            >
              <Icon icon="ep:download" />{{ t('common.export') }}
            </el-button>
            <el-button
              type="danger"
              plain
            ...
            >
              <Icon icon="ep:delete" />{{ t('common.deleteBatch') }}
            </el-button>
          </el-form-item>
        </el-form>
      </ContentWrap>
          ...
          <el-table-column :label="t('common.action')" align="center" width="160">
            <template #default="scope">
              <div class="flex items-center justify-center">
                ...
                >
                  <Icon icon="ep:edit" />{{ t('common.edit') }}
                </el-button>
                <el-dropdown
...
const handleStatusChange = async (row: UserApi.UserVO) => {
  try {
    ...
    await message.confirm(t('system.user.statusChangeConfirm', { text, username: row.username }))
    // 发起修改状态

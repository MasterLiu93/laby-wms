      ...
      <el-row>
        <el-col :span="12">
          <el-form-item :label="t('system.user.mobile')" prop="mobile">
            <el-input v-model="formData.mobile" maxlength="11" :placeholder="t('system.user.mobilePlaceholder')" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="t('system.user.email')" prop="email">
            <el-input v-model="formData.email" maxlength="50" :placeholder="t('system.user.emailPlaceholder')" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>

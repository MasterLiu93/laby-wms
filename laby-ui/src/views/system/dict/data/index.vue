<template>
  <ContentWrap>
    <el-form
      ...
      label-width="80px"
    >
      <el-form-item :label="t('system.dict.name')" prop="dictType">
      ...
      <el-form-item :label="t('common.status')" prop="status">
        <el-select v-model="queryParams.status" :placeholder="t('system.dict.dataStatusPlaceholder')" clearable class="!w-240px">
          <el-option
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" @selection-change="handleRowCheckboxChange">
      ...
      <el-table-column :label="t('system.dict.dataId')" align="center" prop="id" />
      <el-table-column :label="t('system.dict.label')" align="center" prop="label" />
      <el-table-column :label="t('system.dict.value')" align="center" prop="value" />
      <el-table-column :label="t('system.dict.dataSort')" align="center" prop="sort" />
      <el-table-column :label="t('common.status')" align="center" prop="status">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.COMMON_STATUS" :value="scope.row.status" />
        </template>
      </el-table-column>
      <el-table-column :label="t('system.dict.colorType')" align="center" prop="colorType" />
      <el-table-column :label="t('system.dict.cssClass')" align="center" prop="cssClass" />
...
const handleExport = async () => {
  try {
    ...
    download.excel(data, t('system.dict.dataExportFileName'))
  } catch {
  } finally {

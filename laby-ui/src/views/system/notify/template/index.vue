<template>
    ...
    >
      <el-form-item :label="t('system.notifyTemplate.name')" prop="name">
        <el-input
          ...
          :placeholder="t('system.notifyTemplate.namePlaceholder')"
          clearable
      ...
      <el-form-item :label="t('system.notifyTemplate.code')" prop="code">
        <el-input
          ...
          :placeholder="t('system.notifyTemplate.codePlaceholder')"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
      ...
      <el-form-item :label="t('common.status')" prop="status">
        <el-select
          ...
          :placeholder="t('system.notifyTemplate.statusPlaceholder')"
          clearable
          class="!w-240px"
        >
          <el-option
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" @selection-change="handleRowCheckboxChange">
      ...
      <el-table-column
        :label="t('system.notifyTemplate.code')"
        align="center"
        prop="code"
        width="120"
      ...
      />
      <el-table-column
        :label="t('system.notifyTemplate.name')"
        align="center"
        prop="name"
        width="120"
        :show-overflow-tooltip="true"
      />
      <el-table-column :label="t('system.notifyTemplate.type')" align="center" prop="type">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.SYSTEM_NOTIFY_TEMPLATE_TYPE" :value="scope.row.type" />
        </template>
      </el-table-column>
      <el-table-column :label="t('system.notifyTemplate.nickname')" align="center" prop="nickname" />
      <el-table-column
        :label="t('system.notifyTemplate.content')"
        align="center"
        prop="content"
        width="200"
        :show-overflow-tooltip="true"
      />
      <el-table-column :label="t('system.notifyTemplate.status')" align="center" prop="status" width="80">
        <template #default="scope">

<template>
    ...
    >
      <el-form-item :label="t('system.mailTemplate.code')" prop="code">
        <el-input
          ...
          :placeholder="t('system.mailTemplate.codePlaceholder')"
          clearable
      ...
      <el-form-item :label="t('system.mailTemplate.name')" prop="name">
        <el-input
          ...
          :placeholder="t('system.mailTemplate.namePlaceholder')"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
      ...
      <el-form-item :label="t('system.mailTemplate.accountId')" prop="accountId">
        <el-select
          ...
          :placeholder="t('system.mailTemplate.accountIdPlaceholder')"
          clearable
          class="!w-240px"
        >
          <el-option
      ...
      <el-form-item :label="t('system.mailTemplate.status')" prop="status">
        <el-select
          ...
          :placeholder="t('system.mailTemplate.statusPlaceholder')"
          clearable
          class="!w-240px"
        >
          <el-option
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" @selection-change="handleRowCheckboxChange">
      ...
      <el-table-column
        :label="t('system.mailTemplate.code')"
        align="center"
        prop="code"
        width="120"
      ...
      />
      <el-table-column
        :label="t('system.mailTemplate.name')"
        align="center"
        prop="name"
        width="120"
        :show-overflow-tooltip="true"
      />
      <el-table-column
        :label="t('system.mailTemplate.title')"
        align="center"
        prop="title"
        width="150"
        :show-overflow-tooltip="true"
      />
      <el-table-column
        :label="t('system.mailTemplate.content')"
        align="center"
        prop="content"
        min-width="200"
        :show-overflow-tooltip="true"
      />
      <el-table-column :label="t('system.mailTemplate.accountId')" align="center" prop="accountId" width="200">
        <template #default="scope">
          {{ getAccountMail(scope.row.accountId) }}
        </template>
      </el-table-column>
      <el-table-column
        :label="t('system.mailTemplate.nickname')"
        align="center"
        prop="nickname"
        width="120"
        :show-overflow-tooltip="true"

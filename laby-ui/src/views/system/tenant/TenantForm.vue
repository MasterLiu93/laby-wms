<template>
  <Dialog v-model="dialogVisible" :title="dialogTitle" width="50%">
    ...
    >
      ...
      <el-form-item :label="t('system.tenant.package')" prop="packageId">
        <el-select v-model="formData.packageId" clearable :placeholder="t('system.tenant.packagePlaceholder')">
          <el-option
      ...
      <el-form-item :label="t('system.tenant.websites')" prop="websites">
        <el-input-tag
          v-model="formData.websites"
          :placeholder="t('system.tenant.websitesPlaceholder')"
          class="w-full"
        />
      </el-form-item>
...
const formRules = reactive({
  ...
  packageId: [{ required: true, message: t('system.tenant.packageRequired'), trigger: 'blur' }],

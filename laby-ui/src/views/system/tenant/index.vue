<template>
    ...
    >
      <el-form-item :label="t('system.tenant.name')" prop="name">
        <el-input
          ...
          :placeholder="t('system.tenant.namePlaceholder')"
          clearable
      ...
      <el-form-item :label="t('system.tenant.contactName')" prop="contactName">
        <el-input
          ...
          :placeholder="t('system.tenant.contactNamePlaceholder')"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
      ...
      <el-form-item :label="t('system.tenant.contactMobile')" prop="contactMobile">
        <el-input
          ...
          :placeholder="t('system.tenant.contactMobilePlaceholder')"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
      ...
      <el-form-item :label="t('system.tenant.status')" prop="status">
        <el-select
          ...
          :placeholder="t('system.tenant.statusPlaceholder')"
          clearable
          class="!w-240px"
        >
          <el-option
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" @selection-change="handleRowCheckboxChange">
      ...
      <el-table-column :label="t('system.tenant.id')" align="center" prop="id" />
      <el-table-column :label="t('system.tenant.name')" align="center" prop="name" />
      <el-table-column :label="t('system.tenant.package')" align="center" prop="packageId">
      ...
      <el-table-column :label="t('system.tenant.contactName')" align="center" prop="contactName" />
      <el-table-column :label="t('system.tenant.contactMobile')" align="center" prop="contactMobile" />
      <el-table-column :label="t('system.tenant.accountCount')" align="center" prop="accountCount">
        <template #default="scope">
      ...
      />
      <el-table-column :label="t('system.tenant.websites')" align="center" prop="websites" width="180">
        <template #default="scope">
      ...
      <el-table-column :label="t('system.tenant.status')" align="center" prop="status">
        <template #default="scope">
      ...
      <el-table-column
        ...
        :formatter="dateFormatter"
      />
      <el-table-column :label="t('common.action')" align="center" min-width="110" fixed="right">
        <template #default="scope">
          <el-button
            link
            type="primary"

...
<template>
  <Dialog :title="dialogTitle" v-model="dialogVisible" width="800px">
    ...
    >
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item :label="t('wms.moveType')" prop="moveType">
            <el-select v-model="formData.moveType" :placeholder="t('wms.moveTypePlaceholder')" class="!w-full">
              <el-option
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="t('wms.goods')" prop="goodsId">
            <el-select
              ...
              :placeholder="t('wms.goodsPlaceholder')"
              filterable
              class="!w-full"
        ...
        <el-col :span="12">
          <el-form-item :label="t('wms.batchNo')" prop="batchNo">
            <el-input v-model="formData.batchNo" :placeholder="t('wms.batchNoPlaceholder')" />
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="t('wms.fromLocation')" prop="fromLocationId">
            <el-select
              v-model="formData.fromLocationId"
              :placeholder="t('wms.fromLocationPlaceholder')"
              filterable
              class="!w-full"
        ...
        <el-col :span="12">
          <el-form-item :label="t('wms.toLocation')" prop="toLocationId">
            <el-select
              v-model="formData.toLocationId"
              :placeholder="t('wms.toLocationPlaceholder')"
              filterable
              class="!w-full"
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="t('wms.moveQuantity')" prop="quantity">
            <el-input-number
        ...
        <el-col :span="12">
          <el-form-item :label="t('wms.moveReason')" prop="moveReason">
            <el-input v-model="formData.moveReason" :placeholder="t('wms.moveReasonPlaceholder')" />
          </el-form-item>
        </el-col>
      </el-row>
...
const formRules = reactive({
  ...
  moveType: [{ required: true, message: t('wms.moveTypeRequired'), trigger: 'change' }],
  goodsId: [{ required: true, message: t('wms.goodsRequired'), trigger: 'change' }],
  fromLocationId: [{ required: true, message: t('wms.fromLocationRequired'), trigger: 'change' }],
  toLocationId: [{ required: true, message: t('wms.toLocationRequired'), trigger: 'change' }],
  quantity: [{ required: true, message: t('wms.quantityRequired'), trigger: 'blur' }]
})
const formRef = ref()
...
const submitForm = async () => {
  ...
  if (formData.value.fromLocationId === formData.value.toLocationId) {
    message.error(t('wms.sameLocationError'))
    return
  }
